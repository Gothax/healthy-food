...
export default {
  ...
  methods: {
    ...
    async sendMessage() {
      ...
      // Bot response indicating it is processing
      const botProcessingMessage = { sender: 'Bot', text: '잠시만 기다려주세요...', type: 'text' };
      this.messages.push(botProcessingMessage);
      this.scrollToBottom();
      ...
      // Remove the processing message before adding the actual response
      this.messages.pop();
