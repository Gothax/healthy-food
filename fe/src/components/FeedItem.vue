    ...
    <div>
        ...
        <div class="my-6 flex justify-between">
            <div class="flex space-x-6">
                ...
                <!-- OpenCommentModal 클릭하면 this.isCommentModalOpen = true; -->
                <div class="flex items-center space-x-2">
                    <button @click="openCommentModal" class="comment-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <!-- 클릭시 아래 isCommentModalOpen = true 되서 CommentForm으로 isCommentModalOpen 줌 -->
        <CommentModalView v-if="isCommentModalOpen" @close-modal=" isCommentModalOpen = false">
            <CommentForm :post="post" :isCommentModalOpen="isCommentModalOpen" @closeModal="isCommentModalOpen = false"/>
        </CommentModalView>
...
export default {
    ...
    methods: {
        ...
        // add this.isCommentModalOpen = false;
        closeModal(event) {
...
.comment-icon:hover svg {
    fill: rgb(206, 191, 191); /* 마우스 오버 시 색상 변경 */
}
